...
void main() {
  ...
  group('BackupService Tests', () {
    test('performBackup creates database backup file', () async {
    ...
    test('performIntegratedBackup creates comprehensive backup', () async {
      final isar = await IsarDb.instance.open();
    ...
    test('performIntegratedBackup with encryption creates encrypted backup', () async {
      final isar = await IsarDb.instance.open();
    ...
    test('restoreIntegratedBackup successfully restores from backup', () async {
      final isar = await IsarDb.instance.open();
    ...
    test('restoreIntegratedBackup handles encrypted backup with password', () async {
      final isar = await IsarDb.instance.open();
    ...
    test('restoreIntegratedBackup fails with wrong password', () async {
      final isar = await IsarDb.instance.open();
    ...
    test('getAvailableBackups lists backup files correctly', () async {
      final isar = await IsarDb.instance.open();
    ...
    test('getBackupStatus returns current backup state', () async {
      final isar = await IsarDb.instance.open();
    ...
    test('testBackupRestore validates backup/restore functionality', () async {
      final isar = await IsarDb.instance.open();
